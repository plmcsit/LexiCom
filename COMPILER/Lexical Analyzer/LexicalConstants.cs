...
namespace Lexical_Analyzer
{
    public class LexicalConstants
    {
        ...
        public class ReservedWordsDelims
        {
            ...
            //public List<char> relop = new List<char> { '"', '\'', '(', condop };
            //public List<char> delim4    = new List<char> { ' ', '\n', '#', caplet };
            //public List<char> delim5    = new List<char> { mathop, '&', '|', ')', period, numbers };
            //public List<char> delim6 = new List<char> { space, numbers, caplet };
            //public List<char> delim7 = new List<char> { '[', '=', mathop, delim_bool };
        ...
        public ReservedWordsDelims AddRange(ReservedWordsDelims rwd)
        {
            ReservedWordsDelims rw = new ReservedWordsDelims();
            Delims d = new Delims();
            rwd.delim_end.AddRange(d.delim_numbers);
            //rwd.condop.AddRange(d.delim_numbers);
            //rwd.condop.AddRange(d.delim_caplet);
        ...
        public Delims AddRange(Delims d)
        {
            ...
            d.delim_lit.AddRange(rsd.delim_digit);
            d.delim_lit.Add('0');
            d.delim_12.AddRange(new List<char>{ '.', '&', '|', ')', '='});
            d.delim_12.AddRange(d.delim_mathOp);
            d.delim_16.AddRange(rsd.delim_digit);
            return d;
        }
