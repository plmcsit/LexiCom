    ...
    public class LexicalConstants
    {
        ...
        public class ReservedWords
        {
            public List<string> rw_whitespace = new List<string> { "Array", "as", "by", "Do", "is", "Let", "Object", "Option", "Otherwise", "of",
                                                                   "Read", "Response", "Say", "Start", "State", "Stop", "String", "Task", "Var" };
            public List<string> rw_1 = new List<string> { "Clear", "End", "EndIf", "Loop", "Skip" };
            public List<string> rw_2 = new List<string> { "Default", "Lead" };
            public List<string> rw_3 = new List<string> { "For", "If", "Until", "LoopIf" };
            public List<string> rw_dtype = new List<string> { "Boolean", "Char", "Double", "Int", "Null", "String" };
